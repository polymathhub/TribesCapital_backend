...
export class LessonsController {
  ...
  ): Promise<{ lessonId: string; questions: any[] }> {
    return this.lessonsService.getLessonQuiz(lessonId);
  }
  ...
  async trackVideoWatch(
    ...
    return this.videoTrackingService.trackVideoWatch(userId, trackingData);
  }
  ...
  async getVideoAnalytics(
    ...
    return this.videoTrackingService.getCourseAnalytics(userId, courseId);
  }
}
