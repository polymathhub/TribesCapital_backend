    ...
    >
      ...
      <div style={{ padding: '14px 18px 16px', display: 'flex', gap: 14 }}>
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: 14, fontWeight: 600, color: COLORS.T1, margin: '0 0 4px', lineHeight: 1.35 }}>{title}</p>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <button style={{ border: 'none', background: COLORS.P, color: COLORS.W, fontSize: 13, padding: '8px 16px', borderRadius: 8, fontWeight: 500, cursor: 'pointer' }}>
              {btn}
            </button>
          </div>
        </div>
